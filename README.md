...
```json
{
  ...
  "symbol": "SYMBOL",
  "decimals": 18,
  "logoURI": "https://cdn.libertyswap.finance/app-tokens/token-logo/0x...png"
}
```
...
```json
{
  ...
  "symbol": "USDC",
  "decimals": 6,
  "logoURI": "https://cdn.libertyswap.finance/app-tokens/token-logo/0x15D38573d2feeb82e7ad5187aB8c1D52810B1f07.png"
}
```
